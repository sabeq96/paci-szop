...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  console.log((data.voltage.find(function (_ref) {
    var id = _ref.id;
    return id === voltage;
  }) || {}).price || 0);
  console.log((data.capacity.find(function (_ref2) {
    var id = _ref2.id;
    return id === capacity;
  }) || {}).price || 0);

  var calcSum = function calcSum() {
    return ((data.voltage.find(function (_ref3) {
      var id = _ref3.id;
      return id === voltage;
    }) || {}).price || 0) + ((data.capacity.find(function (_ref4) {
      var id = _ref4.id;
      return id === capacity;
    }) || {}).price || 0);
  };
...
//# sourceMappingURL=battery.js.54da1013a7f31bb97ad5.hot-update.js.map